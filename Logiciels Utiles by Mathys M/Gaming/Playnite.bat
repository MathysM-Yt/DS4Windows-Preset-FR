...
set "Logiciel=Playnite"

:: Vidéo Youtube
set "Presentation=https://youtu.be/-O8TvnsDEt0"

:: Site officiel / Github
set "Github=https://playnite.link/"

:: Installation automatique
set "Install=winget.exe install --id Playnite.Playnite --exact --source winget --accept-source-agreements --disable-interactivity --silent --accept-package-agreements --force"
