...
set "Logiciel=Boosteroid"

:: Vidéo Youtube
set "Presentation=https://youtu.be/K9o0LZFMEb8"

:: Site officiel / Github
set "Github=https://boosteroid.com/go/b/X9tIf"

:: Installation automatique
set "Install=https://boosteroid.com/win/installer/boosteroid-install-x64.zip"
