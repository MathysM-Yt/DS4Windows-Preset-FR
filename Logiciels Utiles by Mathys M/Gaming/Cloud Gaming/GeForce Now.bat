...
set "Logiciel=Nvidia GeForce Now"

:: Vidéo Youtube
set "Presentation=https://youtu.be/OemSOWHa6xg"

:: Site officiel / Github
set "Github=https://play.geforcenow.com/mall/#/loginwall"

:: Installation automatique
set "Install=https://download.nvidia.com/gfnpc/GeForceNOW-release.exe"
