...
set "Logiciel=Nvidia Profile Inspector"

:: Vidéo Youtube
set "Presentation=https://youtu.be/3ZBCuwvfxl0"

:: Site officiel / Github
set "Github=https://github.com/Orbmu2k/nvidiaProfileInspector"

:: Installation automatique
set "Install=choco.exe install nvidia-profile-inspector -y --no-progress"
