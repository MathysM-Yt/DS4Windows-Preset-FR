...
set "Logiciel=NvCleanstall"

:: Vidéo Youtube
set "Presentation=https://youtu.be/OoifS49iwl8"

:: Site officiel / Github
set "Github=https://www.techpowerup.com/download/techpowerup-nvcleanstall/"

:: Installation automatique
set "Install=winget.exe install --id TechPowerUp.NVCleanstall --exact --source winget --accept-source-agreements --disable-interactivity --silent --accept-package-agreements --force"
