...
set "Logiciel=DLSS Swapper"

:: Vidéo Youtube
set "Presentation=https://youtu.be/Mv2tDV8ef4E"

:: Site officiel / Github
set "Github=https://github.com/beeradmoore/dlss-swapper"

:: Installation automatique
set "Install=winget.exe install --id beeradmoore.dlss-swapper --exact --source winget --accept-source-agreements --disable-interactivity --silent --accept-package-agreements --force"
