...
set "Logiciel=Flow Launcher"

:: Vidéo Youtube
set "Presentation=https://youtu.be/LdvooKqhJBg"

:: Site officiel / Github
set "Github=https://www.flowlauncher.com/"

:: Installation automatique
set "Install=winget.exe install --id Flow-Launcher.Flow-Launcher --exact --source winget --accept-source-agreements --disable-interactivity --silent --accept-package-agreements --force"
