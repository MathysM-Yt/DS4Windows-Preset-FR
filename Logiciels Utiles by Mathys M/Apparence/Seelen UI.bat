...
set "Logiciel=Seelen UI"

:: Vidéo Youtube
set "Presentation=https://youtu.be/Z8XpcYEBw0I"

:: Site officiel / Github
set "Github=https://github.com/eythaann/seelen-ui"

:: Installation automatique
set "Install=winget.exe install --id Seelen.SeelenUI --exact --source winget --accept-source-agreements --disable-interactivity --silent --accept-package-agreements --force"
