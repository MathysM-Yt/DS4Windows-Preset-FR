...
set "Logiciel=Windhawk"

:: Vidéo Youtube
set "Presentation=https://youtu.be/cy4FkMWoqGw"

:: Site officiel / Github
set "Github=https://windhawk.net/"

:: Installation automatique
set "Install=winget.exe install --id RamenSoftware.Windhawk --exact --source winget --accept-source-agreements --disable-interactivity --silent --accept-package-agreements --force"
