...
set "Logiciel=UserDiag"

:: Vidéo Youtube
set "Presentation=https://youtu.be/L9k5cdHBe7g"

:: Site officiel / Github
set "Github=https://userdiag.com/fr/"

:: Installation automatique
set "Install=winget.exe install --id ctrl-f.userdiag --exact --source winget --accept-source-agreements --disable-interactivity --silent --accept-package-agreements --force"
