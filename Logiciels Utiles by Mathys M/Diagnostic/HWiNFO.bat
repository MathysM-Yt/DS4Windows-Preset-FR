...
:: Vidéo Youtube
set "Presentation=https://youtu.be/T7Gk_fa2010"

:: Site officiel / Github
set "Github=https://www.hwinfo.com/"

:: Installation automatique
set "Install=winget.exe install --id REALiX.HWiNFO --exact --source winget --accept-source-agreements --disable-interactivity --silent --accept-package-agreements --force"
