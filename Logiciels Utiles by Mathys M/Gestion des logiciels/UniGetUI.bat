...
set "Logiciel=UniGetUI"

:: Vidéo Youtube
set "Presentation=https://youtu.be/eXVMJrFRlTY"

:: Site officiel / Github
set "Github=https://github.com/devolutions/unigetui"

:: Installation automatique
set "Install=winget.exe install --id Devolutions.UniGetUI --exact --source winget --accept-source-agreements --disable-interactivity --silent --accept-package-agreements --force"
