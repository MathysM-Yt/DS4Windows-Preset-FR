...
set "Logiciel=BCUninstaller"

:: Vidéo Youtube
set "Presentation=https://youtu.be/TZZSXQv5vII"

:: Site officiel / Github
set "Github=https://www.bcuninstaller.com/"

:: Installation automatique
set "Install=winget.exe install --id Klocman.BulkCrapUninstaller --exact --source winget --accept-source-agreements --disable-interactivity --silent --accept-package-agreements --force"
