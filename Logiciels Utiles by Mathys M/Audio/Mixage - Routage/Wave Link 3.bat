...
set "Logiciel=Wave Link 3"

:: Vidéo Youtube
set "Presentation=https://youtu.be/i9ddP-brEi0"

:: Site officiel / Github
set "Github=https://www.elgato.com/fr/fr/s/downloads"

:: Installation automatique
set "Install=winget.exe install --id Elgato.WaveLink --exact --source winget --accept-source-agreements --disable-interactivity --silent --accept-package-agreements --force"
