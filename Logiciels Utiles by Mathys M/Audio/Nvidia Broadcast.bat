...
set "Logiciel=Nvidia Broadcast"

:: Vidéo Youtube
set "Presentation=https://youtu.be/sxboIP2E5Vk"

:: Site officiel / Github
set "Github=https://www.nvidia.com/fr-fr/geforce/broadcasting/broadcast-app/"

:: Installation automatique
set "Install=choco.exe install nvidia-broadcast -y --no-progress"
