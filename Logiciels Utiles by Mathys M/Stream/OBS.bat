...
:: Vidéo Youtube
set "Presentation=https://www.youtube.com/playlist?list=PL42O4TI1DsCOSQgwqbsbvDCw2p5883R1g"

:: Site officiel / Github
set "Github=https://obsproject.com/fr"

:: Installation automatique
set "Install=winget.exe install --id "OBSProject.OBSStudio" --exact --source winget --accept-source-agreements --disable-interactivity --silent --accept-package-agreements --force"
